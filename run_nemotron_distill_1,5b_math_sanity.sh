...
OUTPUT_DIR="/mnt/ddn/vuvlm/geeho/nemotron_cascade_output/DeepSeek-R1-Distill-Qwen-1.5B-math_sanity2"
...
SAVE_FREQ=50                     # Save checkpoint every iteration for OOM recovery
...
COMMON_ARGS=(
    ...
    actor_rollout_ref.rollout.max_num_batched_tokens=32768  # 더 큰 배치 처리
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="deepseek-qwen-distill-1.5b-math-stage1" \
